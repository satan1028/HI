...
struct para1 var1={5,70,	0.10,3.00,0.10,	0.10,3.00,0.10};
	
struct para1 var2={8,70,	0.10,3.00,0.10, 0.10,3.00,0.10};

struct para1 var3={8,70,	0.10,3.00,0.10, 0.10,3.00,0.10};

double binshift = 3;

struct para2 bestlist1[nGlau+2]=
{{1.91,0.91},{0.973,0.34},{1.144,0.452},{1.069,0.41},{1.055,0.356},{0.978,0.357},{1.132,0.427},{1.259,0.508},{0.918,0.331},{1.102,0.43},{1.062,0.397}};
...
{{0.91,1.91},{1.5,3.916},{1.503,3.008},{1.5,3.52},{1.5,3.52},{1.402,2.604},{1.5,2.42},{1.601,3.117},{1.4,3.913},{1.5,3.12},{1.5,3.52}};
...
{{0.91,1.71},{1.3,2.918},{1.4,3.919},{1.3,2.419},{1.3,2.419},{1.3,3.42},{1.4,3.418},{1.5,3.92},{1.2,2.22},{1.4,3.82},{1.3,2.419}};
