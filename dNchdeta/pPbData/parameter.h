...
struct para1{
	...
	double thetamin;	double thetamax;	double thetastep;
        double kmin; 	double kmax;	double kstep;
};
struct para2{
	double thetabest; double kbest;
};
...
TString stdGlaulist[nGlau]={
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_dmin04.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_D04914.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_D06006.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_dmin00.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_dmin08.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_R649.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN70mb_v15_1M_R675.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN65mb_v15_1M_dmin04.root",
 "/lio/lfs/cms/store/user/qixu/Glauber/Phob_Glau_pPb_sNN75mb_v15_1M_dmin04.root"
};
