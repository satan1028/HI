...
void Drawfit(){
	...
	if(sth==0){TString dirname = "std";}
        ...
        TObjString* Glaubername = (TObjString*)f->Get(Form("%s/Glau_%d/Glaubername",dirname.Data(),Gth));
        TVectorD* xmin = (TVectorD*)f->Get(Form("%s/Glau_%d/xmin",dirname.Data(),Gth));
        TVectorD* xmax = (TVectorD*)f->Get(Form("%s/Glau_%d/xmax",dirname.Data(),Gth));
        TVectorD* mubest = (TVectorD*)f->Get(Form("%s/Glau_%d/mubest",dirname.Data(),Gth));
        TVectorD* kbest = (TVectorD*)f->Get(Form("%s/Glau_%d/kbest",dirname.Data(),Gth));
        TVectorD* Ndf = (TVectorD*)f->Get(Form("%s/Glau_%d/Ndf",dirname.Data(),Gth));
        TVectorD* chis = (TVectorD*)f->Get(Form("%s/Glau_%d/chis",dirname.Data(),Gth));
	TVectorD *kpoint = (TVectorD*)f->Get(Form("%s/Glau_%d/kpoint",dirname.Data(),Gth));
