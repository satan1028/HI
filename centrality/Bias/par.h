...
const double bin[]={1.0,0.9,0.6,0.4,0.3,0.2,0.1,0};	//G1.root
//const double bin[]={1.0,0};	//G2.root
int N=(int)(sizeof(bin)/sizeof(double));
int method=0;

const TString datafile="/scratch/xuq7/Centrality/pPbHistEta4.root";

const TString histoname="hHFEnergy4";

struct para1 var1={5,60,	-1.1,-0.1,0.1,	-0.001,0.001,0.0001};
	
struct para1 var2={8,70,	0.60,0.80,0.01, 2.00,3.00,0.05};

struct para1 var3={8,70,	0.50,0.80,0.01, 2.00,4.00,0.10};

double binshift = 3;

struct para2 bestlist1[nGlau+2]=
{{-0.7,0.001},{0.973,0.34},{1.144,0.452},{1.069,0.41},{1.055,0.356},{0.978,0.357},{1.132,0.427},{1.259,0.508},{0.918,0.331},{1.102,0.43},{1.062,0.397}};
...
{{0.60,2.95},{1.5,3.916},{1.503,3.008},{1.5,3.52},{1.5,3.52},{1.402,2.604},{1.5,2.42},{1.601,3.117},{1.4,3.913},{1.5,3.12},{1.5,3.52}};
...
{{0.50,3.30},{1.3,2.918},{1.4,3.919},{1.3,2.419},{1.3,2.419},{1.3,3.42},{1.4,3.418},{1.5,3.92},{1.2,2.22},{1.4,3.82},{1.3,2.419}};
