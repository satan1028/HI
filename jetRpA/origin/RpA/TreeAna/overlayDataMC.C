...
TString PPbfilename="/scratch/xuq7/RpA/akPu3PF/NoResidual/NoGplusNewpthat/newSample/MCPPbakPu3PFjetana_merged.root";

TString histoname=Form("jetpt%sCombinedSpectra",JetIDName.Data());
TString PPbhistoname=Form("jetpt%s_0-100%%",JetIDName.Data());
...
c1->Print(Form("/home/xuq7/CMSSW_6_2_3_patch1/src/jetRpA/RpA/Quality/NoGplusNewpthat/newSample/pic/JetIDcut/akPu3PF/%s/overlay_DataMC.png",JetIDName.Data()));
