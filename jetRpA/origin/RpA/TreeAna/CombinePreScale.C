...
void CombinePreScale()
{
    ...
    const int Nfile = 5 ;
    TFile * f ;
    TString name[]={"jetptEta","jetptphi","jetptchMaxpt", "jetptchMax",    "jetptneuMaxpt",     "jetptneuMaxr",   "jetptneuMax",       "jetptphoMaxpt",  "jetptphoMax",   "jetptchSum",    "jetptneuSum",    "jetptphoSum",  "jetptchSumpt",    "jetptneuSumpt",    "jetptphoSumpt",   "jetptchN",      "jetptneuN",      "jetptphoN",      "jetptSumSum",   "jetptSumSumrawpt",   "jetptSumSumpt"};
    TString etaname[]={"jetpt","rawptJES","jetptneuMaxr","jetptSumSumpt"};
