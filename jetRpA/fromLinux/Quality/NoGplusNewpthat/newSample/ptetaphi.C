...
if(Save){
if(isMC){
c1->Print(Form("PPbCompPP_%.fto%.f.gif",xrange_pt[0],xrange_pt[1]));
c1->Print(Form("PPbCompPP_%.fto%.f.pdf",xrange_pt[0],xrange_pt[1]));
}
else{
c1->Print(Form("DataPPbCompPP_%.fto%.f.gif",xrange_pt[0],xrange_pt[1]));
c1->Print(Form("DataPPbCompPP_%.fto%.f.pdf",xrange_pt[0],xrange_pt[1]));
}
}
