...
TString filename2="MCPPbNoGplus_ak3PFDiJetMassJetNoResidualPt30GenChargeTrkEffHIN12017v5TrkCorr2DCut0EtaBin7_HFsumEta4Bin1_merged.root";

TString dir1="~/CMSSW_6_2_3_patch1/src/jetRpA/RpA/output/JetTrig/JetID/ak3PF/NoResidual/NoGplusNewpthat";
TString dir2="~/CMSSW_6_2_3_patch1/src/jetRpA/RpA/output/JetTrig/JetID/ak3PF/NoResidual/NoGplusNewpthat/NoVz";
...
leg1->AddEntry(rehisto1,"Vzweighted","lp");
leg1->AddEntry(rehisto2,"No Vzweighted","lp");
leg1->Draw("same");
c1->cd(2);
TLatex *T1=new TLatex(0.5,0.92,"|#eta|<1  PYTHIA+HIJING");
T1->SetNDC();
T1->SetTextAlign(12);
T1->SetTextSize(0.05);
T1->SetTextColor(1);
...
hFrame->GetYaxis()->SetTitle("Ratio: NoVz/Vz");
...
l->Draw("same");
T1->Draw("same");
c1->Print("pic/VzCompare_PPb.png");
}
