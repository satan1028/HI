...
if(coll=="PPb")
  TFile *f = new TFile(Form("/home/xuq/Documents/HI/RpA/output/skimTree/%sdata_ppReco_%s_AlljetTrigKurtTrCombFile_merged.root",coll.Data(),algo.Data()));
if(coll=="PbP")
  TFile *f = new TFile(Form("/home/xuq/Documents/HI/RpA/output/skimTree/%sdata_ppReco_%s_AlljetTrigKurtTrCombFile0_6815_JetPt0noIPupperCut.root",coll.Data(),algo.Data()));
...
//	 jetptSumSumrawptEtaBin[dEtaBin]->Fill(jet_pt*jetweight,(chargedSum+photonSum+neutralSum+muSum+eSum)/raw_pt,weight);
  ...
  TString out_name;
  dataType = "DATA";
  out_name=Form("%s%s%sJetID.root",dataType.Data(),coll.Data(),algo.Data());
