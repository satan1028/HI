...
TFile *f=new TFile("/home/xuq/Documents/HI/RpA/output/skimTree/skimfile.root");
const int Ntrig=5;
TString trigName[Ntrig]={"Jet20","Jet40","Jet60","Jet80","Jet100"};

TTree *nt=f->Get("nt");
TFile *fout=new TFile("/home/xuq/Documents/HI/RpA/output/TreeAna/JetTrigvzandcent.root","RECREATE");
