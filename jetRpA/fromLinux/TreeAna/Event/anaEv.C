...
{
      TString out_name;
         out_name=Form("PbP%sEvSel.root",TrigName.Data());

       TFile *out_file = new TFile(Form("/scratch/xuq7/RpA/GlobalEvent/EventSel/Kurtfile/%s",out_name.Data()), "RECREATE");
...
if(run<=211256) continue;//only for Pb pruns at moment
