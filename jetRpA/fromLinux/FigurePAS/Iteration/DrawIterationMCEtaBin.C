...
//f = TFile::Open(Form("/home/xuq/Documents/HI/RpA/output/UnfoldedOutputs/PPb_UnfoPriorGen_akPu3PFKurtMCNoIDCut_MC_jtpt20_EtaBin%s_Inc_v8.root",etabinname[ieta].Data()));
f = TFile::Open(Form("/home/xuq/Documents/HI/RpA/output/UnfoldedOutputs/PbP_UnfoPriorGen_akPu3PFKurtMCNoIDCut_MCJECv17_jtpt20_EtaBin%s_Inc_v17.root",etabinname[ieta].Data()));
TH1D* hReco_cent[N];
...
hFrame->GetYaxis()->SetRangeUser(0.78,1.27);
...
if(ieta==0){
//drawCMS(0.30,0.88,pPbLumi);
TLatex *com2 = new TLatex(0.32,0.88,"CMS simulation");
com2->SetTextFont(42);
com2->SetTextSize(0.06);
com2->SetNDC();
com2->Draw();
//TLatex *com0 = new TLatex(0.32,0.75,"PYTHIA+HIJING");
TLatex *com0 = new TLatex(0.32,0.75,"HIJING+PYTHIA");
com0->SetTextFont(43);
com0->SetTextSize(21);
com0->SetNDC();
com0->Draw();
...
//c5->Print(Form("PPbIteration_MCEtaBin.pdf"));
c5->Print(Form("PbPIteration_MCEtaBin.pdf"));
