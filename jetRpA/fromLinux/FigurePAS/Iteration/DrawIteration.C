...
TLatex *com0 = new TLatex(0.17,0.83,"PYTHIA+HIJING");
com0->SetTextFont(42);
com0->SetTextSize(0.04);
com0->SetNDC();
com0->Draw();
TLatex *com1 = new TLatex(0.17,0.88,"CMS simulation");
com1->SetTextFont(42);
com1->SetTextSize(0.04);
com1->SetNDC();
com1->Draw();

TLatex *com2 = new TLatex(0.65,0.32,etastring[ieta]);
com2->SetTextFont(63);
com2->SetTextSize(17);
com2->SetNDC();
com2->Draw();
...
c1->Print(Form("IterationMC_%s.pdf",etabinname[ieta].Data()));
