...
//TFile *f = TFile::Open("./PPb_UnfoPriorGen_ak3PFNoVzCut_jtpt30_EtaBin-10_10_Inc_v5.root");a
int ieta=7;
TFile *f = TFile::Open(Form("/scratch/xuq7/RpA/JetTrig/DataMC/FromYX/PPb_UnfoPriorGen_akPu3PFKurtMC_MC_jtpt30_EtaBin%s_Inc_v3.root",etabinname[ieta].Data()));
const int N=9;
TH1D* hReco_cent[N];
...
c1->Print(Form("Iteration_%s.pdf",etabinname[ieta].Data()));
