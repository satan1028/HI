...
void Drawselfmatch(){
	...
	hdeltaRWideEta->SetName("hdeltaRWidthEta");
	...
	TCanvas *c5 = new TCanvas("c5","c5",1200,600);
        ...
        hdeltaR->Scale(0.01);
        TH1D* hdeltaRWideEta = (TH1D*)hdeltaRWideEta->Rebin(ndeltaR-1,"hdeltaRWideEta_",deltaRbin);
	...
	tg->AddEntry(hNmatchedWideEta,"|#eta_{lab}|<3");
        tg->Draw("same");
	c1->cd(2)->SetLogy();
	...
	tg_->Clear();
        ...
        tg_->AddEntry(hdeltaRWideEta,"|#eta_{lab}|<3, akPu3PF","lp");
