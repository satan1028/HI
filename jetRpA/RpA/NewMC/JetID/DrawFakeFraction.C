...
T1->SetTextColor(1);
T1->SetTextFont(42);
TLegend *leg1=new TLegend(0.68,0.50,0.92,0.80);
...
if(coll=="PPb"){
	if(ieta==7){
hMC2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%s",JetIDName.Data(),etabinnameswap[ieta].Data()));
hMC_real2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%s_real1",JetIDName.Data(),etabinnameswap[ieta].Data()));
hMC_fake2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%s_fake1",JetIDName.Data(),etabinnameswap[ieta].Data()));
	}
	else{
hMC2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%sEtaBin%s",JetIDName.Data(),etabinnameswap[ieta].Data()));
hMC_real2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%sEtaBin%s_real1",JetIDName.Data(),etabinnameswap[ieta].Data()));
hMC_fake2D[ieta]= (TH2F*)fMCPPb->Get(Form("jetpt%sEtaBin%s_fake1",JetIDName.Data(),etabinnameswap[ieta].Data()));
	}
TString mc="PYTHIA+HIJING";
}
if(coll=="PbP"){
hMC2D[ieta]= (TH2F*)fMCPbP->Get(Form("jetpt%sEtaBin%s",JetIDName.Data(),etabinname[ieta].Data()));
hMC_real2D[ieta]= (TH2F*)fMCPbP->Get(Form("jetpt%sEtaBin%s_real1",JetIDName.Data(),etabinname[ieta].Data()));
hMC_fake2D[ieta]= (TH2F*)fMCPbP->Get(Form("jetpt%sEtaBin%s_fake1",JetIDName.Data(),etabinname[ieta].Data()));
...
for(int ieta=0;ieta<Neta;ieta++) if(canvas[ieta]!=4 && ieta!=7) g_real[ieta]->Draw("Psame");
...
c1->Print(Form("%srealFraction.pdf",coll.Data()));
