...
void JetIDAllTriganalyzeRpATreeLumi()
{
  ...
  TFile *f = new TFile("/scratch/xuq7/RpA/TreeAna/PPbdata_ppReco_akPu3PF_AlljetTrigKurtTrCombFile_merged.root");  
      TFile *fcrel3 = NULL ;
     TH1D *C_rel= NULL ;

     if(coll=="PPb")
        fcrel3 = TFile::Open(Form("/scratch/xuq7/RpA/OldAna/Corrections/Casym_pPb_double_hcalbins_algo_%s_pt100_140_jet80_alphahigh_20_phicut250.root", algo.Data()), "readonly");
     if(coll=="PbP")
        fcrel3 = TFile::Open(Form("/scratch/xuq7/RpA/OldAna/Corrections/Casym_Pbp_double_hcalbins_algo_%s_pt100_140_jet80_alphahigh_20_phicut250.root", algo.Data()), "readonly");
...
//        if(jetTr2[itrig]==1){
	my_hists->jetptEta[itrig]->Fill(jet_pt*jetweight,jet_eta,weight);
	 ...
	 my_hists->jetptchMaxptEtaBin[itrig][dEtaBin]->Fill(jet_pt*jetweight,chargedMax/jet_pt,weight);
