...
void overlayTrigJetIDcut(){
gStyle->SetOptStat(kFALSE);
gStyle->SetErrorX(0);
TString TrigName = "Jet20";
...
TString filename="/scratch/xuq7/RpA/TreeAna/AllTrigLumiDATAPPbakPu3PFDiJetMass_NoPtSel.root";
...
l->SetLineColor(1);
l->Draw("same");
T->DrawLatex(0.25,0.30,Form("Cut: %s<%.2f",JetID.Data(),cut));
T->DrawLatex(0.25,0.20,TrigName);

c1->Print(Form("/home/xuq7/CMSSW_6_2_3_patch1/src/jetRpA/RpA/Quality/NoGplusNewpthat/newSample/pic/JetIDcut/akPu3PF/%s/overlay_JetIDcut_%s.png",JetIDName.Data(),TrigName.Data()));
}
