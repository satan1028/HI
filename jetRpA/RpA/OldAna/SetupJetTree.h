...
public :
   ...
   Float_t         discr_ssvHighEff[504];   //[nref]
   Float_t         discr_prob[504];   //[nref]
...
void setupJetTree(TTree *t,Jets &tJets,bool doCheck = 0)
{
   ...
   if (t->GetBranch("discr_ssvHighEff")) t->SetBranchAddress("discr_ssvHighEff", tJets.discr_ssvHighEff, &tJets.b_discr_ssvHighEff);
   if (t->GetBranch("discr_prob")) t->SetBranchAddress("discr_prob", tJets.discr_prob, &tJets.b_discr_prob);
