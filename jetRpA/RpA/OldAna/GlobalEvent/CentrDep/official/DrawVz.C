...
fixedFontHist(hVz_MC,2,1.8);
fixedFontHist(hVzHF4);
fixedFontHist(hVzHFPlus4);
fixedFontHist(hVzHFPlus);
TString Data_file="/afs/cern.ch/user/q/qixu/CMSSW_5_3_8_HI/src/jetRpA/RpA/output/JetTrig/DataMC/FromYX/PPbCombinedJetTrigakPu3PFJetTrkEffHIN12017v5TrkCorr2DCutAllHistHFsumEta4Bin1.root";
...
makeMultiPanelCanvas(c1,1,2,0,0,0.12,0.12,0.03);
...
fixedFontHist(hVz_Data,2,1.8);
hVz_Data->GetYaxis()->SetTitle("Event Fraction");
hVz_Data->SetMinimum(2*1e-4);
