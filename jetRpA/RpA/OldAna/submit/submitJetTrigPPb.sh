...
ptmin=(15 30 50 80 120 170 220 280 370)
ptmax=(30 50 80 120 170 220 280 370 9999)
#for i in `seq 1 7`;
for (( i=0;i<${#ptmin[@]}; i++))
     do
...
echo "Processing..."
echo "root -l -b -q anaAsyJetTrigPPb.C+"
...
root -b > submit/runjobJetPPb.log <<EOF
.L anaAsyJetTrigPPb_jetid.C+
anaAsyJetTrig()
.q
EOF
      echo "Done! $i"
