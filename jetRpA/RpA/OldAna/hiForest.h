...
*/        
     ...
     */   //for 2013 pp 5 TeV MC with pp tracking
          ...
          trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj50_ak3PF_100_-1_-1000_genJetMode0.root", 50) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj80_ak3PF_100_-1_-1000_genJetMode0.root", 80) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj120_ak3PF_100_-1_-1000_genJetMode0.root", 120) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj170_ak3PF_100_-1_-1000_genJetMode0.root", 170) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj220_ak3PF_100_-1_-1000_genJetMode0.root", 220) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj280_ak3PF_100_-1_-1000_genJetMode0.root", 280) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj370_ak3PF_100_-1_-1000_genJetMode0.root", 370) ;
      //     trackCorrections[i]->AddSample(Form("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPPbppTrackEff_dj%d_ak3PF_100_-1_-1000_genJetMode0.root",pthat), pthat) ;
    /*     // for Pbp efficiency correction
          trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj50_ak3PF_100_-1_-1000_genJetMode0.root", 50) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj80_ak3PF_100_-1_-1000_genJetMode0.root", 80) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj120_ak3PF_100_-1_-1000_genJetMode0.root", 120) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj170_ak3PF_100_-1_-1000_genJetMode0.root", 170) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj220_ak3PF_100_-1_-1000_genJetMode0.root", 220) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj280_ak3PF_100_-1_-1000_genJetMode0.root", 280) ;
           trackCorrections[i]->AddSample("trkcorr/ppIterTrkingCorr_pPb/TrkCorr_5TeVPbPppTrackEff_dj370_ak3PF_100_-1_-1000_genJetMode0.root", 370) ;
   */
    }
       ...
       //  trackCorrections[i]->ppMode_ = (collisionMode==cPP);
        if(collisionMode==cPP) 
         trackCorrections[i]->coll_ = "PP";
       else if(collisionMode==cPbPb) 
         trackCorrections[i]->coll_ = "PbPb";
       else  
         trackCorrections[i]->coll_ = "PPb";
