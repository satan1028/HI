...
TString filename1="MCPPNoGplus_ak3PFDiJetMassJetNoResidualPt30GenChargeTrkEffHIN12017v5TrkCorr2DCut0EtaBin7_HFsumEta4Bin1_merged.root";
TString filename2="mergedCSdiff_MCPPNoGplus_ak3PFIncJetNoResidual_TrkEffHIN12017v5TrkCorr2DCut0EtaBin7_HFsumEta4Bin1_HP04_hiforest77_hiSignal.root";

TString dir1="~/CMSSW_6_2_3_patch1/src/jetRpA/RpA/output/JetTrig/JetID/ak3PF/NoResidual/NoGplusNewpthat/NoVz";
...
TH1D* histo1=(TH1D*)histo12F->ProjectionY("histo1");
TH1D* histo2=(TH1D*)histo22F->ProjectionY("histo2");
...
leg1->Draw("same");
c1->cd(2);
TLatex *T1=new TLatex(0.5,0.92,"|#eta|<1  PYTHIA");
T1->SetNDC();
T1->SetTextAlign(12);
T1->SetTextSize(0.05);
T1->SetTextColor(1);
...
hFrame->GetYaxis()->SetTitle("Ratio: Yaxian/Qiao");
...
l->Draw("same");
T1->Draw("same");
c1->Print("pic/YXQiaoComparePP.png");
}
