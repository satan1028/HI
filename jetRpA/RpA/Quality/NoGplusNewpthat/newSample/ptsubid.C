...
for(int i=0;i<N;i++){
if(i==N-1){
TH1F* histo1=(TH1F*)fPPb->Get(Form("jetpt%s_0-100%%",etabinname[i].Data()));
TH1F* histo2=(TH1F*)fPPb->Get(Form("jetptsubid%s_0-100%%",etabinname[i].Data()));
}
else{
TH1F* histo1=(TH1F*)fPPb->Get(Form("jetptEtaBin%s_Cen0-100%%",etabinname[i].Data()));
TH1F* histo2=(TH1F*)fPPb->Get(Form("jetptsubidEtaBin%s_Cen0-100%%",etabinname[i].Data()));
}
...
l->Draw("same");
T1->Draw("same");
c1->Print("pic/centWeight/subidsysPPb.png");
c1->Print("pic/centWeight/subidsysPPb.pdf");
