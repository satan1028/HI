...
TH2F* histo12F=(TH2F*)fPPb->Get(histoname1);
TH2F* histo22F=(TH2F*)fPPbOld->Get(histoname1);
...
//TH1D* histo1=(TH1D*)fPPb->Get(histoname);
//TH1D* histo2=(TH1D*)fPPbOld->Get(histoname);
