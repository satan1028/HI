...
////////
 ...
 hist->Draw();
  ...
  //TF1 *V2vsPt = new TF1("V2vsPt","((x/5)^1.8/(1+(x/3)^1.8))*(.00005+(1/x)^0.8)",0.2,10);
  ...
  gr5->Draw("psameez");
    ...
    TLatex *tex1= new TLatex(5,0.305,"STEG, 10k events");
    tex1->SetTextColor(1);
  ...
  c1->Print("eventplanev2.gif");
  //c1->Print("eventplanev2.C");
