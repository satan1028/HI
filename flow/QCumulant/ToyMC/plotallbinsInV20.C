void plotallbinsInV20(){
    int inV2=0; double inv2 = 0;
    TString method = "closed";
    const int ntotbins = 9;
    int xbin=0;
    int dir[ntotbins] = {30,40,65,80,100,120,150,185,300};
    ...
    TLine *l5 = new TLine(0,inqc22,320,inqc22);
    TLine *l6 = new TLine(0,inqc24,320,inqc24);
    TLine *l7 = new TLine(0,inqc26,320,inqc26);
    l1->SetLineStyle(2);
    l2->SetLineStyle(2);
    l3->SetLineStyle(2);
    l4->SetLineStyle(2);
    ...
    grc22->GetYaxis()->SetRangeUser(-1e-6,1e-5);
    ...
    grqc22->GetYaxis()->SetRangeUser(1e-12,0.01);
