...
const TString dir = "/lio/lfs/cms/store/user/qixu/flow/NewSTEG/pPbDataV205m120";
const TString outdir = "/scratch/xuq7/flow/QCumulant/pPbDataV205m120";
...
const int nptv= 9;
const int netav= 12;
const int trkbin[]={121,119};
const int nbin = 1;
const int nsamples=50;
const double inV2=0.0502178;
const TString method = "closed";
const int maxN = 6;
