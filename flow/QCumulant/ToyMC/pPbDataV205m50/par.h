...
const TString dir = "/lio/lfs/cms/store/user/qixu/flow/NewSTEG/pPbDataV205m50";
const TString outdir = "/scratch/xuq7/flow/QCumulant/pPbDataV205m50";
