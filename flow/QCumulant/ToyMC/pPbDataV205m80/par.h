...
const TString dir = "/lio/lfs/cms/store/user/qixu/flow/NewSTEG/pPbDataV205m80";
const TString outdir = "/scratch/xuq7/flow/QCumulant/pPbDataV205m80";
