 ...
 */
void
Analyze1(const TString& mode="CLOSED",
        UShort_t       maxH=6,
        Bool_t         /*doLoops*/=false)
{
  ...
  // --- Setup input ------------------------------------------------
  TFile*   file = TFile::Open("/store/user/qixu/flow/NewSTEG/pPbDataV205m300/vndata_50k_14.root", "READ");
...
//  TArrayD* pWeights = &weights;
  tree->SetBranchAddress("phig", pPhis);
