...
V2vsPt->GetXaxis()->CenterTitle();
V2vsPt->GetYaxis()->CenterTitle();
V2vsPt->GetXaxis()->SetTitleSize(0.05);
V2vsPt->GetYaxis()->SetTitleSize(0.05);
V2vsPt->GetXaxis()->SetTitleOffset(0.9);
V2vsPt->GetYaxis()->SetTitleOffset(0.9);
