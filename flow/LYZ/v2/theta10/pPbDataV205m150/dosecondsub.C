...
void dosecondsub(){
	...
	for(int i=start;i<end;i++){	
		if(isSum)	name=Form("/lio/lfs/cms/store/user/qixu/flow/pbsjoboutput/pPbDataV205m150/Anav_Prod_sub_%d.root",i);
		else		name=Form("/lio/lfs/cms/store/user/qixu/flow/pbsjoboutput/pPbDataV205m150/Anav_Prod2_sub_%d.root",i);
		remove(name.Data());
