...
for(int i=shift;i<shift+ntotbin;i++){
	...
	TGraphErrors *gr24=new TGraphErrors(npt24,pt,v24[t-1],0,v24err[t-1]);
	TGraphErrors *gr26=new TGraphErrors(npt24,pt,v26[t-1],0,v26err[t-1]);
	TGraphErrors *gr28=new TGraphErrors(npt24,pt,v28[t-1],0,v28err[t-1]);
	grProd->SetMarkerSize(1.5);
	grProd->SetMarkerStyle(20);
	grProd->SetMarkerColor(1);
	grProd->SetLineColor(1);
	grProdtc->SetMarkerSize(1.5);
	grProdtc->SetMarkerStyle(24);
	grProdtc->SetMarkerColor(2);
	grProdtc->SetLineColor(2);
	grProdlc->SetMarkerSize(1.5);
	grProdlc->SetMarkerStyle(24);
	grProdlc->SetMarkerColor(4);
	grProdlc->SetLineColor(4);
