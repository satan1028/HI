...
TVectorD *vecDr = f->Get(Form("D_%d/D_%d/r",xbin,xeta));
TVectorD *vecDg2 = f->Get(Form("D_%d/D_%d/D_%d/G2",xbin,xeta,xtheta));
TVectorD *vecDr0 = f->Get(Form("D_%d/D_%d/r0",xbin,xeta,xtheta));
TVectorD *vecDr01 = f->Get(Form("D_%d/D_%d/r01",xbin,xeta,xtheta));
