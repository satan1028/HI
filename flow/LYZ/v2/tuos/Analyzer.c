...
#define kr 200
#define kt 5
#define Vmax 0.13*400
#define Vstep 0.0006*400
#define Vmax3 0.075*400
#define Vstep3 0.00034*400
#define Vmax5 0.035*400
#define Vstep5 0.00015*400
#define NB_SLICE 1
#define NB_SLICE_PT 10 //13
#define sqr(x) ((x)*(x))
...
//  double maxptcut[NB_SLICE_PT] = {0.7,1.1,1.4,1.75,2.2,2.75,3.45,4.2,5.05,6.0,7.2,8.5,10.0}; //13
  double minptcut[NB_SLICE_PT] = {0.2,0.5,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0};
  double maxptcut[NB_SLICE_PT] = {0.5,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0,10.0}; //10
  ...
  outR.close();
     ...
     char *file1 = "/home/xuq7/CMSSW_5_3_8_HI/src/UserCode/flow/proSTEGvn/vndata_10k.root";
