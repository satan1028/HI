...
void dosecond(){
	...
	for(int i=start;i<end;i++){	
		if(isSum)	name=Form("/lio/lfs/cms/store/user/qixu/flow/pbsjoboutput/pPbDataV205m185/Anav_Prod_%d.root",i);
		else		name=Form("/lio/lfs/cms/store/user/qixu/flow/pbsjoboutput/pPbDataV205m185/Anav_Prod2_%d.root",i);
		remove(name.Data());
