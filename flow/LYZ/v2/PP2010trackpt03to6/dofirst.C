...
void dofirst(){
	...
	for(int i=start;i<end;i++){
		if(isSum)	name=Form("/scratch/xuq7/flow/pbsjoboutput/PP2010trackpt03to6/AnaV_Sum_%d.root",i);
		else	name=Form("/scratch/xuq7/flow/pbsjoboutput/PP2010trackpt03to6/AnaV_Prod_%d.root",i);
		remove(name.Data());
