...
const int netav= 12;
const int nbin = 53;
const int trkbin[]={600,550,500,450,400,350,300,280,260,250,240,230,220,210,200,195,190,185,180,175,170,165,160,155,150,145,140,135,130,125,120,115,110,105,100,95,90,85,80,75,70,65,60,55,50,45,40,35,30,25,20,15,10,0};
const int nn=2;
const int mm=1;
