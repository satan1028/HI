void plotallbins(){
 ...
 const int nbin22 = 18;   const double V22err[nbin22]={0.002093,0.002117,0.002098,0.002145,0.002204,0.002267,0.002355,0.002453,0.002504,0.002587,0.002643,0.002686,0.00381,0.003833,0.005163,0.005103,0.004962,0.0049};
    const int ntot = 5;
    const int nnonf = 2;
