...
boost             := boost
ALL_TOOLS      += boost
boost_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/boost/1.44.0-cms3/include
...
boost_python_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/boost/1.44.0-cms3/include
...
bz2lib             := bz2lib
ALL_TOOLS      += bz2lib
bz2lib_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/bz2lib/1.0.5-cms/include
...
charybdis             := charybdis
ALL_TOOLS      += charybdis
charybdis_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/charybdis/1.003-cms6/include
...
classlib             := classlib
ALL_TOOLS      += classlib
classlib_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/classlib/3.1.2-cms2/include
...
clhep             := clhep
ALL_TOOLS      += clhep
clhep_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/clhep/2.0.4.6-cms/include
...
cppunit             := cppunit
ALL_TOOLS      += cppunit
cppunit_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/cppunit/1.12.1-cms2/include
...
db4             := db4
ALL_TOOLS      += db4
db4_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/db4/4.4.20-cms/include
...
dcap             := dcap
ALL_TOOLS      += dcap
dcap_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/dcap/2.47.5.0-cms2/include
...
evtgenlhc             := evtgenlhc
ALL_TOOLS      += evtgenlhc
evtgenlhc_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/evtgenlhc/9.1-cms10
...
fftjet             := fftjet
ALL_TOOLS      += fftjet
fftjet_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/fftjet/1.3.1-cms6/include
...
fftw3             := fftw3
ALL_TOOLS      += fftw3
fftw3_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/fftw3/3.2.2-cms4/include
...
frontier_client_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/frontier_client/2.8.4/include
...
gdbm             := gdbm
ALL_TOOLS      += gdbm
gdbm_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/gdbm/1.8.3-cms/include
...
geant4core_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/geant4/9.4-cms/include
...
gsl             := gsl
ALL_TOOLS      += gsl
gsl_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/gsl/1.10-cms5/include
...
hepmc_headers_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/hepmc/2.05.01-cms4/include
...
heppdt             := heppdt
ALL_TOOLS      += heppdt
heppdt_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/heppdt/3.03.00-cms/include
...
herwig             := herwig
ALL_TOOLS      += herwig
herwig_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/herwig/6.520-cms9/include
...
jimmy_headers_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/jimmy/4.2-cms19/include
...
ktjet             := ktjet
ALL_TOOLS      += ktjet
ktjet_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/ktjet/1.06-cms3/include
...
lhapdf             := lhapdf
ALL_TOOLS      += lhapdf
lhapdf_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/lhapdf/5.8.5-cms2/include
...
libhepml             := libhepml
ALL_TOOLS      += libhepml
libhepml_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/libhepml/0.2.1-cms/interface
...
libjpg             := libjpg
ALL_TOOLS      += libjpg
libjpg_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/libjpg/8b/include
...
libpng             := libpng
ALL_TOOLS      += libpng
libpng_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/libpng/1.2.10-cms4/include
...
libtiff             := libtiff
ALL_TOOLS      += libtiff
libtiff_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/libtiff/3.9.4-cms/include
...
libungif             := libungif
ALL_TOOLS      += libungif
libungif_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/libungif/4.1.4-cms/include
...
mcdb             := mcdb
ALL_TOOLS      += mcdb
mcdb_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/mcdb/1.0.2-cms4/interface
...
openssl             := openssl
ALL_TOOLS      += openssl
openssl_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/openssl/0.9.8e-cms5/include
...
photos_headers_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/photos/215.5-cms3/include
...
protobuf             := protobuf
ALL_TOOLS      += protobuf
protobuf_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/protobuf/2.4.1/include
...
pythia6_headers_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/pythia6/424-cms3/include
...
pythia8             := pythia8
ALL_TOOLS      += pythia8
pythia8_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/pythia8/145-cms4/include
...
python             := python
ALL_TOOLS      += python
python_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/python/2.6.4-cms14/include/python2.6
...
qt             := qt
ALL_TOOLS      += qt
qt_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/QtOpenGL /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/QtGui
...
qt3support_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/Qt3Support
...
qtdesigner_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/QtDesigner
...
qtextra             := qtextra
ALL_TOOLS      += qtextra
qtextra_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/qt/4.6.3-cms/include/QtScript
...
roofitcore_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/lcg/roofit/5.28.00a-cms17/include
...
tauola_headers_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/tauola/27.121.5-cms14/include
...
thepeg             := thepeg
ALL_TOOLS      += thepeg
thepeg_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/thepeg/1.7.0-cms4/include
...
tkonlinesw_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/tkonlinesw/2.7.0-cms11/include
...
uuid             := uuid
ALL_TOOLS      += uuid
uuid_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/uuid/1.38-cms2/include
...
xdaq             := xdaq
ALL_TOOLS      += xdaq
xdaq_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/xdaq/VR17173-cms/include /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/xdaq/VR17173-cms/include/linux
...
xerces-c             := xerces-c
ALL_TOOLS      += xerces-c
xerces-c_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/xerces-c/2.8.0-cms/include
...
xz             := xz
ALL_TOOLS      += xz
xz_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/xz/5.0.3/include
...
zlib             := zlib
ALL_TOOLS      += zlib
zlib_LOC_INCLUDE := /cvmfs/cms.cern.ch/slc5_amd64_gcc434/external/zlib/1.2.3-cms/include
