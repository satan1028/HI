...
public :
   ...
   Int_t           nLooseTracks_pt_100;
   Int_t           nHighPurTracks_pt_100;
   Int_t           processType;
   Float_t         priVtxX;
   Float_t         priVtxY;
   Float_t         priVtxZ;
   ...
   std::vector<float>   *Xi3DIpSig;
   std::vector<float>   *XiFLsig3D;
   std::vector<double>  *V3dIpWrtPrimary;
   std::vector<double>  *V3dIpWrtPrimarySig;
   std::vector<double>  *VTrkPi2DIp;
   std::vector<double>  *VTrkPi2DIpSig;
   std::vector<double>  *VTrkPi3DIp;
   std::vector<double>  *VTrkPi3DIpSig;
   std::vector<double>  *VTrkP2DIp;
   std::vector<double>  *VTrkP2DIpSig;
   std::vector<double>  *VTrkP3DIp;
   std::vector<double>  *VTrkP3DIpSig;
   std::vector<double>  *batPi2DIp;
   std::vector<double>  *batPi2DIpSig;
   ...
   std::vector<int>     *genXiMotherPDG;
   std::vector<float>   *genXiProdVtxX;
   std::vector<float>   *genXiProdVtxY;
   std::vector<float>   *genXiProdVtxZ;
   ...
   TBranch        *b_nLooseTracks_pt_100;   //!
   TBranch        *b_nHighPurTracks_pt_100;   //!
   ...
   TBranch        *b_VCosThetaPAndveeVertexToXiVertexVector;   //!
   ...
   TBranch        *b_VTrkPi2DIp;   //!
   TBranch        *b_VTrkPi2DIpSig;   //!
   TBranch        *b_VTrkPi3DIp;   //!
   TBranch        *b_VTrkPi3DIpSig;   //!
   TBranch        *b_VTrkP2DIp;   //!
   TBranch        *b_VTrkP2DIpSig;   //!
   TBranch        *b_VTrkP3DIp;   //!
   TBranch        *b_VTrkP3DIpSig;   //!
   TBranch        *b_batPi2DIp;   //!
   TBranch        *b_batPi2DIpSig;   //!
   TBranch        *b_batPi3DIp;   //!
   ...
   TBranch        *b_genXiMomL;   //!
   TBranch        *b_genXiQ;   //!
   TBranch        *b_genXiMotherPDG;   //!
   TBranch        *b_genXiProdVtxX;   //!
   TBranch        *b_genXiProdVtxY;   //!
   TBranch        *b_genXiProdVtxZ;   //!
   
   seleXiMC(TTree *tree=0);
   virtual ~seleXiMC();
   ...
   void SetNEvents(int);
   void SetWeightChoice(int, std::string);
...
#ifdef seleXiMC_cxx
seleXiMC::seleXiMC(TTree *tree){
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
     std::cout << "Error. No ttree supplied" << std::endl;
   }
   Init(tree);
   nEvents = -1;
   theSqrtS = "900GeV";
...
Int_t seleXiMC::GetEntry(Long64_t entry){
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t seleXiMC::LoadTree(Long64_t entry){
...
void seleXiMC::Init(TTree *tree){
   ...
   VCosThetaPAndveeVertexToXiVertexVector = 0;
   ...
   fChain->SetBranchAddress("HFpE", &HFpE, &b_HFpE);
   fChain->SetBranchAddress("HFmE", &HFmE, &b_HFmE);
   ...
   fChain->SetBranchAddress("nLooseTracks_pt_100", &nLooseTracks_pt_100, &b_nLooseTracks_pt_100);
   fChain->SetBranchAddress("nHighPurTracks_pt_100", &nHighPurTracks_pt_100, &b_nHighPurTracks_pt_100);
   ...
   fChain->SetBranchAddress("VPalongXi", &VPalongXi, &b_VPalongXi);
   ...
   fChain->SetBranchAddress("VRSig2D", &VRSig2D, &b_VRSig2D);
   fChain->SetBranchAddress("VRSig3D", &VRSig3D, &b_VRSig3D);
   ...
   fChain->SetBranchAddress("VCosThetaPAndveeVertexToXiVertexVector", &VCosThetaPAndveeVertexToXiVertexVector, &b_VCosThetaPAndveeVertexToXiVertexVector);
   ...
   fChain->SetBranchAddress("Xi3DIpSig", &Xi3DIpSig, &b_Xi3DIpSig);
   fChain->SetBranchAddress("XiFLsig3D", &XiFLsig3D, &b_XiFLsig3D);
   ...
   fChain->SetBranchAddress("VTrkPi2DIp", &VTrkPi2DIp, &b_VTrkPi2DIp);
   fChain->SetBranchAddress("VTrkPi2DIpSig", &VTrkPi2DIpSig, &b_VTrkPi2DIpSig);
   ...
   fChain->SetBranchAddress("VTrkP2DIp", &VTrkP2DIp, &b_VTrkP2DIp);
   fChain->SetBranchAddress("VTrkP2DIpSig", &VTrkP2DIpSig, &b_VTrkP2DIpSig);
   fChain->SetBranchAddress("VTrkP3DIp", &VTrkP3DIp, &b_VTrkP3DIp);
   fChain->SetBranchAddress("VTrkP3DIpSig", &VTrkP3DIpSig, &b_VTrkP3DIpSig);
   fChain->SetBranchAddress("batPi2DIp", &batPi2DIp, &b_batPi2DIp);
   fChain->SetBranchAddress("batPi2DIpSig", &batPi2DIpSig, &b_batPi2DIpSig);
   ...
   fChain->SetBranchAddress("genXiMotherPDG", &genXiMotherPDG, &b_genXiMotherPDG);
   fChain->SetBranchAddress("genXiProdVtxX", &genXiProdVtxX, &b_genXiProdVtxX);
   fChain->SetBranchAddress("genXiProdVtxY", &genXiProdVtxY, &b_genXiProdVtxY);
   fChain->SetBranchAddress("genXiProdVtxZ", &genXiProdVtxZ, &b_genXiProdVtxZ);
   Notify();
}

Bool_t seleXiMC::Notify(){
...
void seleXiMC::Show(Long64_t entry){
...
Int_t seleXiMC::Cut(Long64_t entry){
...
void seleXiMC::SetNEvents(int theNumberOfEvents){
  nEvents = theNumberOfEvents;
}

void seleXiMC::SetDataType(std::string theType, std::string sqrtS){
  if(theType == "data")isData = true;
  if(theType == "mc")isData = false;
  theSqrtS = sqrtS;
}

void seleXiMC::WriteHistos(){
  theOutRootFile->Write();
  theOutRootFile->Close();
}

void seleXiMC::SetWeightChoice(int theWeight, std::string theWeightType){
  weightChoice = theWeight;
  weightType = theWeightType;
}

void seleXiMC::SetCutValues(float xi3dCut, float batpi3dCut, float v0pi3dCut, float v0proton3dCut, float sepCut, float vxtclCut){
