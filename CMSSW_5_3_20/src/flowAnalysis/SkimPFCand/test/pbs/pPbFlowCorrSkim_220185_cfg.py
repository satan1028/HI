...
#####combine###############
# histogram output
filenameout = "/lio/lfs/cms/store/user/qixu/flow/PACorrHM/skim/PFcandi/tracktest/pbs/M220185/FlowHM"+sys.argv[3]+"/pPbskimAnaTree_"+sys.argv[2]+".root"
...
process.demo = cms.EDAnalyzer('SkimPFCand',
   ...
   trkbin = cms.untracked.vint32(220,185),
