...
#'/store/user/tuos/DatapPbFlowSkim/pPb_HM_553_1_hIJ.root'
),
...
process.TFileService = cms.Service("TFileService",
                                  fileName = cms.string("pPbAnaTree.root"))

process.demo = cms.EDAnalyzer('LYZsecond',
   n = cms.untracked.int32(2),
   m = cms.untracked.int32(1),
   way = cms.untracked.int32(0),
   ...
   res = cms.untracked.string("/home/xuq7/tmp/flow/CMSSW_5_3_8_HI_patch2/src/Analysis/LYZfirst/test/pbs/mergedV_Sum.root")
