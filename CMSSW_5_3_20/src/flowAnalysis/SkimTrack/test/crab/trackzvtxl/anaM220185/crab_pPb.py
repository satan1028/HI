...
config.General.requestName = 'FlowLYZHMpPb'

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'skimtrack_220185_cfi.py'
...
config.Data.outLFNDirBase = '/store/user/qixu/flow/PACorrHM/skim/trackzvtxl/multiM220185/FlowLYZHMpPb'
