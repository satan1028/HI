...
#ifndef lam_efficiency_subgeant2_h
#define lam_efficiency_subgeant2_h
...
class lam_efficiency_subgeant2 {
public :
   ...
   lam_efficiency_subgeant2(TTree *tree);
   virtual ~lam_efficiency_subgeant2();
...
#ifdef lam_efficiency_subgeant2_cxx
lam_efficiency_subgeant2::lam_efficiency_subgeant2(TTree *tree)
{
   Init(tree);
}

lam_efficiency_subgeant2::~lam_efficiency_subgeant2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t lam_efficiency_subgeant2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t lam_efficiency_subgeant2::LoadTree(Long64_t entry)
{
...
void lam_efficiency_subgeant2::Init(TTree *tree)
{
...
Bool_t lam_efficiency_subgeant2::Notify()
{
...
void lam_efficiency_subgeant2::Show(Long64_t entry)
{
...
Int_t lam_efficiency_subgeant2::Cut(Long64_t entry)
{
...
#endif // #ifdef lam_efficiency_subgeant2_cxx
