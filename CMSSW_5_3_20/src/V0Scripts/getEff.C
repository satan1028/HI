...
Int_t status_lam = gSystem->Load("./lam_efficiency_C.so");
...
//  vector< vector<TString> > output_rec_plots(3, vector<TString>(4));
  ...
  for ( Int_t i = 0; i < variables.size(); ++i ) {
    for ( Int_t j = 0; j < formats.size(); ++j ) {
      output_rec_plots[i][j] = "plots/" + v0type + "_dNd" + variables[i] + "_rec_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      output_gen_plots[i][j] = "plots/" + v0type + "_dNd" + variables[i] + "_gen_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      output_eff_plots[i][j] = "plots/" + v0type + "_dNd" + variables[i] + "_eff_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
    }
  }
...
if ( v0type == "lam" ) {
  ...
  for ( Int_t i = 0; i < variables.size(); ++i ) {
    for ( Int_t j = 0; j < formats.size(); ++j ) {
      part_output_rec_plots[i][j] = "plots/" + v0type + "Reg_dNd" + variables[i] + "_rec_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      part_output_gen_plots[i][j] = "plots/" + v0type + "Reg_dNd" + variables[i] + "_gen_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      part_output_eff_plots[i][j] = "plots/" + v0type + "Reg_dNd" + variables[i] + "_eff_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      anti_output_rec_plots[i][j] = "plots/" + v0type + "Bar_dNd" + variables[i] + "_rec_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      anti_output_gen_plots[i][j] = "plots/" + v0type + "Bar_dNd" + variables[i] + "_gen_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
      anti_output_eff_plots[i][j] = "plots/" + v0type + "Bar_dNd" + variables[i] + "_eff_" + mctype + "_" + energy + "_weight" + weightchoice + "." + formats[j];
    }
  }
}

  TString outFileName = "eff_dNdX_" + v0type + "_" + mctype + "_" + energy + "_weight" + weightchoice + ".root";
 ...
 if( kshort ) {
   ...
   leff = new lam_efficiency(lamTree);
