...
process.recHitAna = cms.EDAnalyzer('PixelRecHitAnalyzer',
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('recHitAna.root')
)
...
process.path = cms.Path(process.hltMinBiasHFOrBSC*process.collisionEventSelection*process.siPixelRecHits*process.recHitAna)
