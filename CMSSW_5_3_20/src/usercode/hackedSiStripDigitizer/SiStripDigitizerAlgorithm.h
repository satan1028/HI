...
class SiStripDigitizerAlgorithm {
 public:
  ...
  void  run(edm::DetSet<SiStripDigi>&, edm::DetSet<SiStripRawDigi>&,
            // --- BEGIN HACK --- //
            edm::DetSet<SiStripRawDigi>&, edm::DetSet<SiStripRawDigi>&,
 ...
 private:
  ...
  // --- BEGIN HACK --- //
  std::vector<double> detSignalAmpl;
  std::vector<double> detNoiseAmpl;
  // --- END HACK --- //
  ...
  // --- BEGIN HACK --- //  
  DigitalRawVecType rawnoisedigis;
  DigitalRawVecType rawsignaldigis;
  // --- END HACK --- //
