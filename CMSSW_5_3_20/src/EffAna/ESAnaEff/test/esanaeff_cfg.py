...
process.TFileService = cms.Service("TFileService",
                                  fileName = cms.string("ES_v1.root"))


process.demo = cms.EDAnalyzer('ESAnaEff'
)

#Using CutGplus
process.p = cms.Path(process.hltZeroBiasSingleTrack * process.PAcollisionEventSelection * process.pileupVertexFilterCutGplus * process.demo)

#Without CutGplus
#process.p = cms.Path(process.hltZeroBiasSingleTrack * process.PAcollisionEventSelection *  process.demo)
