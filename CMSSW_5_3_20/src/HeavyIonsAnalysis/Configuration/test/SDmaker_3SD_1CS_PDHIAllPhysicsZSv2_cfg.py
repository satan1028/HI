...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/user/c/cvscmssw/public/CMSSW/CMSSW/HeavyIonsAnalysis/Configuration/test/SDmaker_3SD_1CS_PDHIAllPhysicsZSv2_cfg.py,v $')
)
